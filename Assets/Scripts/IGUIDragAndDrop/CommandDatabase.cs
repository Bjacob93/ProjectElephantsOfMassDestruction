...
public class CommandDatabase : MonoBehaviour {
	...
	void Start(){
        ...
        commandDatabase.Add(new Command("second time", "FoE2", "This var splits the units' target so that the first unit goes to A while the second unit goes to B ", false, true, true, new Vector3(), 2));

        commandDatabase.Add(new Command("three times", "FoE3", "This var splits the units' target so that the first and second unit goes to A while the third unit goes to B ", false, true, true, new Vector3(), 3));
        ...
        {
            commandDatabase.Add(new Command("checkpoint " + c.name, "var" + c.name, "This targets the location of the given checkpoint " + c.name, false, true, true, c.transform.position,0));
        }
